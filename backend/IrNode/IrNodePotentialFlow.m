...
%==============================================================================
    ...
    methods
        ...
        function obj = IrNodePotentialFlow(pfObj, inverse)
        % IRNODEPOTENTIALFLOW
        ...
        % GENERATEDERIVATIVEVAR
            ...
            if fWanted == true
                derivLabelFunc = @getDerivFLabel;
            elseif qWanted == true
                derivLabelFunc = @getDerivQLabel;
            end
            ...
            if thisPF.dummy == false
                ...
                if  thisPF.lhs == false && derivObj == pfObj && qWanted == false 
                        ...
                        headNode = IrNodeNumerical.getConstantNode(constVal);
                    %end
                else
