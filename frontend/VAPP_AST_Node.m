...
%==============================================================================
    ...
    methods
        ...
        function out = accept_visitor(self, visitor)
            out = self.visitMethod(visitor, self);
        end
        ...
        function set_type(self, Type)
            self.Type = Type;
            self.visitMethod = str2func(['visit', upper(Type(1)), Type(2:end)]);
        end
